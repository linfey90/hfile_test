...
public class HoodieHFileReader<R extends IndexedRecord> implements HoodieFileReader<R> {
  ...
  public long readTrailer() {
    return reader.getTrailer().getLoadOnOpenDataOffset();
  }

  public HFileBlock readBlock(long offset) throws Exception {
    return reader.readBlock(offset, -1, true, true, false, true, null, null);
  }
   ...
   */
  @Override
  public Set<String> filterRowKeys(List<String> candidateRowKeys) {
 ...
 @Override
  ...
  public static Option<GenericRecord> fetchRecordByKeyInternal(HFileScanner scanner, String key, Schema writerSchema, Schema readerSchema) throws IOException {
  ...
  public static <R extends IndexedRecord> List<R> readAllRecords(HoodieHFileReader<R> reader) throws IOException {
    ...
    return CollectionUtils.toStream(reader.getRecordIterator(schema))
  ...
  public static <R extends IndexedRecord> List<R> readRecords(HoodieHFileReader<R> reader,
    ...
    return CollectionUtils.toStream(reader.getRecordsByKeysIterator(keys, schema))
        .collect(Collectors.toList());
  }
