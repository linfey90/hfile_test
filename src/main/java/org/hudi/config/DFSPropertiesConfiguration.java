...
import org.util.FSUtils;
import org.util.HoodieIOException;
...
public class DFSPropertiesConfiguration {
  ...
  public DFSPropertiesConfiguration(Configuration hadoopConf, Path filePath) {
