...
//import org.apache.hadoop.hbase.io.User;
...
//
//  /**
//   * TestRead case for HBASE-22127 in LruBlockCache.
//   */
//  @TestRead
...
//    Reader reader = HFile.createReader(fs, storeFilePath, cacheConfig, true, conf);
//    long offset = 0;
...
//
//  /**
//   * TestRead case for HBASE-22127 in CombinedBlockCache
//   */
//  @TestRead
...
//    System.out.println(writeStoreFile());
//  }
...
//
//  /**
//   * TestRead empty HFile. TestRead all features work reasonably when hfile is empty of entries.
//   */
//  @TestRead
...
//
//  @TestRead
//  public void testTFileNoTags() throws IOException {
//    basicWithSomeCodec("none", false);
//  }
//
//
//
//  @TestRead
//  public void testWriteManyCol() throws IOException {
//    Path path = new Path("/home/bigdata/data", testName.getMethodName());
...
//        .withCompression(Compression.Algorithm.NONE).withCompressTags(false).build();
//    HFileWriterImpl writer =
//      new HFileWriterImpl(conf, cacheConf, path, fout, fileContext);
//    CellBuilder cellBuilder = CellBuilderFactory.create(CellBuilderType.SHALLOW_COPY);
//    byte[] row = Bytes.toBytes("foo");
//    byte[] qualifier = Bytes.toBytes("qualifier");
//    byte[] cf = Bytes.toBytes(columnFamily);
...
//  }
//
//  private String path = "/home/bigdata/data/hfile_1kw";
//  private int count = 10000000;
//  @TestRead
//  public void testWriteFileNoTags() throws IOException {
//    String codec = "none";
...
//    LOG.info("---write cost:{} s", DateTimeUtils.getCostS(start));
//    fout.close();
//  }
//
//  private void writeRecords2(Writer writer, boolean useTags, int total) throws IOException {
//    String value = "value";
//    KeyValue kv;
...
//        writer.append(kv);
//      } else {
//        User user = new User(i, "name"+key, "address"+key);
//        kv = new KeyValue(Bytes.toBytes(key), Bytes.toBytes("family"), Bytes.toBytes("qual"),
...
//
//  @TestRead
//  public void testReadFileNoTags() throws IOException {
//    String codec = "none";
//    boolean useTags = false;
//    Path ncHFile = new Path(path);
...
//    for(int i=1;i<=10;i++){
//      long start = System.nanoTime();
//      int data = random.nextInt(count/i);
...
//      LOG.info("---read cost:{} ms", DateTimeUtils.getCostMs(start));
//    }
//    reader.close();
//    fin.close();
...
//
//  /**
//   * TestRead case for CombinedBlockCache with TinyLfu as L1 cache
//   */
//  @TestRead
...
//
//  /**
//   * TestRead case for CombinedBlockCache with AdaptiveLRU as L1 cache
//   */
//  @TestRead
